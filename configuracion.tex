...
\newcommand{\caratulaTapa}{
	\begin{titlepage}
		...
		{\fontsize{12}{14}\selectfont
			Trabajo de proyecto de grado \textcolor{red}{(lo que corresponda según Reglamento de modalidades de graduación)}
			presentado en consideración de la Universidad Católica Boliviana "San Pablo",
			como requisito para optar el Grado Académico de Licenciatura en \Carrera 
		}
